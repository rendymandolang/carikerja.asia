...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    <div>
        ...
        <div class="text-muted">Update penting tentang lamaran dan proses rekrutmen Anda.</div>
    </div>
            ...
            <div class="list-group-item {{ $notification->read_at ? '' : 'bg-light' }}">
                <div class="d-flex flex-wrap justify-content-between gap-3">
                    ...
                    <div class="d-flex gap-2 align-items-start">
                        ...
                        @endif
                        @if (! $notification->read_at)
                            <form method="POST" action="{{ route('candidate.notifications.read', $notification->id) }}">
                                @csrf
